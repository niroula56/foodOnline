...
def registerUser(request):
    ...
    #         user.save()
    #         return redirect(reverse("registerUser"))
            ...
            messages.success(request, "Your account has been registered successfully! Check your mail to activate your account.")
...
def forgot_password(request):
    if request.method == "POST":
        ...
        if User.objects.filter(email=email).exists():
            ...
            messages.error(request, "Account does'nt exist")
